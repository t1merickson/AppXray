...
struct DetectedTechnologies: OptionSet, Sendable {
  ...
  static let go          = DetectedTechnologies(rawValue: 1 << 28)
  static let kotlin      = DetectedTechnologies(rawValue: 1 << 29)

  // MARK: - Game Engines & Runtimes (bits 30-35)
  ...
  // MARK: - Additional Frameworks & Tooling (bits 36+)

  static let wails       = DetectedTechnologies(rawValue: 1 << 36)
  static let gtk         = DetectedTechnologies(rawValue: 1 << 37)
  static let sdl         = DetectedTechnologies(rawValue: 1 << 38)
  static let nwjs        = DetectedTechnologies(rawValue: 1 << 39)
...
extension DetectedTechnologies {
  ...
  var symbolName: String {
    ...
    case .wails:        return "globe.badge.chevron.backward"
    case .gtk:          return "square.grid.2x2"
    case .sdl:          return "rectangle.on.rectangle.angled"
    case .nwjs:         return "globe"
    case .javafx:       return "cup.and.saucer"
    // Languages
...
extension DetectedTechnologies {
  ...
  static let distributionFlags: [DetectedTechnologies] = [
    .sparkle, .squirrel,
  ]
